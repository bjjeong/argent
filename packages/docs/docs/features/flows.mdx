...
A script can also return data, for example the name of a user that the script created. A later step can type the data into a field or print the data in a label. See [Script output](/docs/reference/flow-yaml#script-output).
